...
# -- Car setup ---
car1 = p.loadURDF("racecar/racecar.urdf", basePosition=[-2, 0, 0.2])
car2 = p.loadURDF("racecar/racecar.urdf", basePosition=[2, 0, 0.2])

for car in (car1, car2):
    p.changeDynamics(car, -1, restitution=0.9, lateralFriction=0.05, linearDamping=0.01, angularDamping=0.01)
...
while True:
    ...
    contacts = p.getContactPoints(car1, car2)
